    ...
    <Layout>
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="overflow-x-auto">
            ...
            <tbody>
              {data_auto.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 border border-white"><a href={`/reads/${row.filename}/${row.filename}_R1_fastqc.html`} target="_blank" rel="noopener noreferrer"  className="ml-4 text-blue-500 hover:underline">R1 </a><a href={`/reads/${row.filename}/${row.filename}_R2_fastqc.html`} target="_blank" rel="noopener noreferrer"  className="ml-4 text-blue-500 hover:underline">R2 </a></td> 
          ...
          <a href={`/sv/${row.filename}/${row.filename}.html`} target="_blank" rel="noopener noreferrer"  className="ml-4 text-blue-500 hover:underline">SV's</a></td> 
                </tr>
              ))}
            </tbody>
          </table>
