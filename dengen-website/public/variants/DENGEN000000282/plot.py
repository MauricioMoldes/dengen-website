...
#   plot-vcfstats -p /mnt/dengen/results/outdir/45srbatef-103857684733-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01686-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05479_22RKG008607 /mnt/dengen/results/stats/45srbatef-103857684733-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01686-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05479_22RKG008607_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 45srb .. /ngc/projects2/gm/data/archive/2022/variants/snv/45srbatef-103857684733-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01686-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05479_22RKG008607_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='45srb')
    has_data = 1
