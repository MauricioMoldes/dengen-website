...
#   plot-vcfstats -p /mnt/dengen/results/outdir/64rmegwef-103908483701-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01424-220912_A01411_AHYNYWDSX3-EXT_LABKA_NGCWGS-NGCWGS05200 /mnt/dengen/results/stats/64rmegwef-103908483701-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01424-220912_A01411_AHYNYWDSX3-EXT_LABKA_NGCWGS-NGCWGS05200_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 64rme .. /ngc/projects2/gm/data/archive/2022/variants/snv/64rmegwef-103908483701-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01424-220912_A01411_AHYNYWDSX3-EXT_LABKA_NGCWGS-NGCWGS05200_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='64rme')
    has_data = 1
