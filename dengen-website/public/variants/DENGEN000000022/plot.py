...
#   plot-vcfstats -p /mnt/dengen/results/outdir/02anthecf-103851051046-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220324_A01176_AHCFCNDSX3-RHGM_LABKA_WGS-WGS04033 /mnt/dengen/results/stats/02anthecf-103851051046-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220324_A01176_AHCFCNDSX3-RHGM_LABKA_WGS-WGS04033_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 02ant .. /ngc/projects2/gm/data/archive/2022/variants/snv/02anthecf-103851051046-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220324_A01176_AHCFCNDSX3-RHGM_LABKA_WGS-WGS04033_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='02ant')
    has_data = 1
