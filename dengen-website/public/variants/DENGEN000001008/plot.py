...
#   plot-vcfstats -p /mnt/dengen/results/outdir/77raratim-103886312350-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01567-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05368_22RKG015825 /mnt/dengen/results/stats/77raratim-103886312350-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01567-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05368_22RKG015825_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 77rar .. /ngc/projects2/gm/data/archive/2022/variants/snv/77raratim-103886312350-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01567-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05368_22RKG015825_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='77rar')
    has_data = 1
