...
#   plot-vcfstats -p /mnt/dengen/results/outdir/10wesspim-103909051473-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01368-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05146_22RKG019107 /mnt/dengen/results/stats/10wesspim-103909051473-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01368-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05146_22RKG019107_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 10wes .. /ngc/projects2/gm/data/archive/2022/variants/snv/10wesspim-103909051473-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01368-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05146_22RKG019107_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='10wes')
    has_data = 1
