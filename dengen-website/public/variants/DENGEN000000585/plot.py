...
#   plot-vcfstats -p /mnt/dengen/results/outdir/66ilsconf-110297594382-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02091-221021_A00559_BH3FHJDSX5-EXT_LABKA_NGCWGS-NGCWGS05946 /mnt/dengen/results/stats/66ilsconf-110297594382-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02091-221021_A00559_BH3FHJDSX5-EXT_LABKA_NGCWGS-NGCWGS05946_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 66ils .. /ngc/projects2/gm/data/archive/2022/variants/snv/66ilsconf-110297594382-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02091-221021_A00559_BH3FHJDSX5-EXT_LABKA_NGCWGS-NGCWGS05946_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='66ils')
    has_data = 1
