...
#   plot-vcfstats -p /mnt/dengen/results/outdir/16artiowf-103909045805-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01331-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05109_22RKG016467 /mnt/dengen/results/stats/16artiowf-103909045805-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01331-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05109_22RKG016467_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 16art .. /ngc/projects2/gm/data/archive/2022/variants/snv/16artiowf-103909045805-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01331-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05109_22RKG016467_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='16art')
    has_data = 1
