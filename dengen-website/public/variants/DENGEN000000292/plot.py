...
#   plot-vcfstats -p /mnt/dengen/results/outdir/46owasesm-103910251243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01537-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05379 /mnt/dengen/results/stats/46owasesm-103910251243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01537-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05379_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 46owa .. /ngc/projects2/gm/data/archive/2022/variants/snv/46owasesm-103910251243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01537-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05379_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='46owa')
    has_data = 1
