...
#   plot-vcfstats -p /mnt/dengen/results/outdir/14blacasm-103913367897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01740-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05501_21RKG011890 /mnt/dengen/results/stats/14blacasm-103913367897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01740-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05501_21RKG011890_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 14bla .. /ngc/projects2/gm/data/archive/2022/variants/snv/14blacasm-103913367897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01740-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05501_21RKG011890_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='14bla')
    has_data = 1
