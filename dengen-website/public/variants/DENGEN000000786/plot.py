...
#   plot-vcfstats -p /mnt/dengen/results/outdir/72watrtum-110301509514-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02194-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06044 /mnt/dengen/results/stats/72watrtum-110301509514-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02194-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06044_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 72wat .. /ngc/projects2/gm/data/archive/2022/variants/snv/72watrtum-110301509514-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02194-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06044_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='72wat')
    has_data = 1
