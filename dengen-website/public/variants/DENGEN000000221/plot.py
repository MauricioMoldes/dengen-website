...
#   plot-vcfstats -p /mnt/dengen/results/outdir/21oinsatm-103860620210-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00730-220422_A01176_BH2CKMDSX3-EXT_LABKA_NGCWGS-NGCWGS04163 /mnt/dengen/results/stats/21oinsatm-103860620210-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00730-220422_A01176_BH2CKMDSX3-EXT_LABKA_NGCWGS-NGCWGS04163_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 21oin .. /ngc/projects2/gm/data/archive/2022/variants/snv/21oinsatm-103860620210-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00730-220422_A01176_BH2CKMDSX3-EXT_LABKA_NGCWGS-NGCWGS04163_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='21oin')
    has_data = 1
