...
#   plot-vcfstats -p /mnt/dengen/results/outdir/19siarerm-103803187138-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03339 /mnt/dengen/results/stats/19siarerm-103803187138-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03339_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 19sia .. /ngc/projects2/gm/data/archive/2022/variants/snv/19siarerm-103803187138-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03339_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='19sia')
    has_data = 1
