...
#   plot-vcfstats -p /mnt/dengen/results/outdir/80heansem-103909038086-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01306-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05084_22RKG009333 /mnt/dengen/results/stats/80heansem-103909038086-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01306-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05084_22RKG009333_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 80hea .. /ngc/projects2/gm/data/archive/2022/variants/snv/80heansem-103909038086-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01306-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05084_22RKG009333_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='80hea')
    has_data = 1
