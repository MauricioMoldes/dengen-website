...
#   plot-vcfstats -p /mnt/dengen/results/outdir/79rechacf-103719164410-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00110-210323_A01176_AH27F5DSX2-EXT_LABKA_NGCWGS-NGCWGS00025_794572cd0 /mnt/dengen/results/stats/79rechacf-103719164410-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00110-210323_A01176_AH27F5DSX2-EXT_LABKA_NGCWGS-NGCWGS00025_794572cd0_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 79rec .. /ngc/projects2/gm/data/archive/2022/variants/snv/79rechacf-103719164410-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00110-210323_A01176_AH27F5DSX2-EXT_LABKA_NGCWGS-NGCWGS00025_794572cd0_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='79rec')
    has_data = 1
