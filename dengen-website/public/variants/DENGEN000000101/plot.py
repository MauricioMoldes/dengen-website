...
#   plot-vcfstats -p /mnt/dengen/results/outdir/08thfitim-103904619102-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01188-220831_A01961_BHTNYFDSX3-EXT_LABKA_NGCWGS-NGCWGS04944_21RKG025996x01 /mnt/dengen/results/stats/08thfitim-103904619102-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01188-220831_A01961_BHTNYFDSX3-EXT_LABKA_NGCWGS-NGCWGS04944_21RKG025996x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 08thf .. /ngc/projects2/gm/data/archive/2022/variants/snv/08thfitim-103904619102-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01188-220831_A01961_BHTNYFDSX3-EXT_LABKA_NGCWGS-NGCWGS04944_21RKG025996x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='08thf')
    has_data = 1
