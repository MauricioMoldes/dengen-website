...
#   plot-vcfstats -p /mnt/dengen/results/outdir/19chonerm-103873925022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220525_A01176_AHJ5HGDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04340_22RKG012410x01 /mnt/dengen/results/stats/19chonerm-103873925022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220525_A01176_AHJ5HGDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04340_22RKG012410x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 19cho .. /ngc/projects2/gm/data/archive/2022/variants/snv/19chonerm-103873925022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220525_A01176_AHJ5HGDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04340_22RKG012410x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='19cho')
    has_data = 1
