...
#   plot-vcfstats -p /mnt/dengen/results/outdir/85whalfom-110302813675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_BH3THMDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06067_22RKG026051x01 /mnt/dengen/results/stats/85whalfom-110302813675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_BH3THMDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06067_22RKG026051x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 85wha .. /ngc/projects2/gm/data/archive/2022/variants/snv/85whalfom-110302813675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_BH3THMDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06067_22RKG026051x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='85wha')
    has_data = 1
