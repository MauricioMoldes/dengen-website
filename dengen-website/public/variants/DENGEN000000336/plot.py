...
#   plot-vcfstats -p /mnt/dengen/results/outdir/52cousinm-103878765791-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04445 /mnt/dengen/results/stats/52cousinm-103878765791-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04445_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 52cou .. /ngc/projects2/gm/data/archive/2022/variants/snv/52cousinm-103878765791-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04445_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='52cou')
    has_data = 1
