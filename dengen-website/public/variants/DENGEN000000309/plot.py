...
#   plot-vcfstats -p /mnt/dengen/results/outdir/48avipanf-103895881966-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01048-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04744 /mnt/dengen/results/stats/48avipanf-103895881966-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01048-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04744_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 48avi .. /ngc/projects2/gm/data/archive/2022/variants/snv/48avipanf-103895881966-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01048-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04744_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='48avi')
    has_data = 1
