...
#   plot-vcfstats -p /mnt/dengen/results/outdir/63onmaref-103900915203-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01101-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04826 /mnt/dengen/results/stats/63onmaref-103900915203-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01101-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04826_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 63onm .. /ngc/projects2/gm/data/archive/2022/variants/snv/63onmaref-103900915203-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01101-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04826_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='63onm')
    has_data = 1
