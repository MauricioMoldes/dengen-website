...
#   plot-vcfstats -p /mnt/dengen/results/outdir/91wonghef-103853915943-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220330_A00559_BHCF7CDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04038_22RKG007110x01 /mnt/dengen/results/stats/91wonghef-103853915943-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220330_A00559_BHCF7CDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04038_22RKG007110x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 91won .. /ngc/projects2/gm/data/archive/2022/variants/snv/91wonghef-103853915943-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220330_A00559_BHCF7CDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04038_22RKG007110x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='91won')
    has_data = 1
