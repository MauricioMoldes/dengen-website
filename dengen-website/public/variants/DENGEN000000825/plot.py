...
#   plot-vcfstats -p /mnt/dengen/results/outdir/73wangesf-103873951929-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00845-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04392 /mnt/dengen/results/stats/73wangesf-103873951929-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00845-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04392_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 73wan .. /ngc/projects2/gm/data/archive/2022/variants/snv/73wangesf-103873951929-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00845-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04392_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='73wan')
    has_data = 1
