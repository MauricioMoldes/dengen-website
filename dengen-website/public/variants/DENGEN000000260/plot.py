...
#   plot-vcfstats -p /mnt/dengen/results/outdir/41widegof-103863103151-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00731-220427_A01411_AHJ5CLDSX3-EXT_LABKA_NGCWGS-NGCWGS04178 /mnt/dengen/results/stats/41widegof-103863103151-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00731-220427_A01411_AHJ5CLDSX3-EXT_LABKA_NGCWGS-NGCWGS04178_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 41wid .. /ngc/projects2/gm/data/archive/2022/variants/snv/41widegof-103863103151-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00731-220427_A01411_AHJ5CLDSX3-EXT_LABKA_NGCWGS-NGCWGS04178_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='41wid')
    has_data = 1
