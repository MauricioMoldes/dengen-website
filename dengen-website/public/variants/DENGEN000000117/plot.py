...
#   plot-vcfstats -p /mnt/dengen/results/outdir/11exwbasm-110302886168-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02242-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06126 /mnt/dengen/results/stats/11exwbasm-110302886168-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02242-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06126_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 11exw .. /ngc/projects2/gm/data/archive/2022/variants/snv/11exwbasm-110302886168-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02242-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06126_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='11exw')
    has_data = 1
