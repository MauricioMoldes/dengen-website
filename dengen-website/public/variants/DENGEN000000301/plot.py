...
#   plot-vcfstats -p /mnt/dengen/results/outdir/47orytupm-110294817623-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02074-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05853 /mnt/dengen/results/stats/47orytupm-110294817623-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02074-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05853_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 47ory .. /ngc/projects2/gm/data/archive/2022/variants/snv/47orytupm-110294817623-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02074-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05853_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='47ory')
    has_data = 1
