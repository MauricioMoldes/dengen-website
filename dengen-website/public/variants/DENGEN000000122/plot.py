...
#   plot-vcfstats -p /mnt/dengen/results/outdir/11iterocf-103851571457-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01282-220907_A01411_AHYN3VDSX3-EXT_LABKA_NGCWGS-NGCWGS05058_22RKG006946x01 /mnt/dengen/results/stats/11iterocf-103851571457-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01282-220907_A01411_AHYN3VDSX3-EXT_LABKA_NGCWGS-NGCWGS05058_22RKG006946x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 11ite .. /ngc/projects2/gm/data/archive/2022/variants/snv/11iterocf-103851571457-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01282-220907_A01411_AHYN3VDSX3-EXT_LABKA_NGCWGS-NGCWGS05058_22RKG006946x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='11ite')
    has_data = 1
