...
#   plot-vcfstats -p /mnt/dengen/results/outdir/48beaveom-103877202815-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220622_A01176_AHKCKLDSX3-RHGM_LABKA_WGS-WGS04471NY /mnt/dengen/results/stats/48beaveom-103877202815-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220622_A01176_AHKCKLDSX3-RHGM_LABKA_WGS-WGS04471NY_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 48bea .. /ngc/projects2/gm/data/archive/2022/variants/snv/48beaveom-103877202815-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220622_A01176_AHKCKLDSX3-RHGM_LABKA_WGS-WGS04471NY_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='48bea')
    has_data = 1
