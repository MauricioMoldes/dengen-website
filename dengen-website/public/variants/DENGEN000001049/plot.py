...
#   plot-vcfstats -p /mnt/dengen/results/outdir/78indircf-103776943848-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00309-210921_A01411_BHJTJJDSX2-EXT_LABKA_NGCWGS-NGCWGS00202_21RKG021218x001 /mnt/dengen/results/stats/78indircf-103776943848-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00309-210921_A01411_BHJTJJDSX2-EXT_LABKA_NGCWGS-NGCWGS00202_21RKG021218x001_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 78ind .. /ngc/projects2/gm/data/archive/2022/variants/snv/78indircf-103776943848-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00309-210921_A01411_BHJTJJDSX2-EXT_LABKA_NGCWGS-NGCWGS00202_21RKG021218x001_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='78ind')
    has_data = 1
...
if plot_indel_vaf and len(dat)>0:
    ...
    ax1 = fig.add_subplot(111)
    ax1.plot([-60,60], [0.5,0.5],color='#c5c5c5')
