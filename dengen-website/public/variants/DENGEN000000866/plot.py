...
#   plot-vcfstats -p /mnt/dengen/results/outdir/75cedbanf-103867475886-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00751-220512_A01411_AHJ5TVDSX3-EXT_LABKA_NGCWGS-NGCWGS04233 /mnt/dengen/results/stats/75cedbanf-103867475886-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00751-220512_A01411_AHJ5TVDSX3-EXT_LABKA_NGCWGS-NGCWGS04233_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 75ced .. /ngc/projects2/gm/data/archive/2022/variants/snv/75cedbanf-103867475886-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00751-220512_A01411_AHJ5TVDSX3-EXT_LABKA_NGCWGS-NGCWGS04233_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='75ced')
    has_data = 1
