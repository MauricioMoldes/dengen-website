...
#   plot-vcfstats -p /mnt/dengen/results/outdir/02bemerwm-110294827653-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01977-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05795 /mnt/dengen/results/stats/02bemerwm-110294827653-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01977-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05795_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 02bem .. /ngc/projects2/gm/data/archive/2022/variants/snv/02bemerwm-110294827653-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01977-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05795_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='02bem')
    has_data = 1
