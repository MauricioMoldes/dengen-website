...
#   plot-vcfstats -p /mnt/dengen/results/outdir/87orideom-103909057170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01398-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05163_22RKG018723 /mnt/dengen/results/stats/87orideom-103909057170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01398-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05163_22RKG018723_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 87ori .. /ngc/projects2/gm/data/archive/2022/variants/snv/87orideom-103909057170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01398-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05163_22RKG018723_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='87ori')
    has_data = 1
