...
#   plot-vcfstats -p /mnt/dengen/results/outdir/58psthanm-103915637522-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01774-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05608_22RKG011019 /mnt/dengen/results/stats/58psthanm-103915637522-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01774-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05608_22RKG011019_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 58pst .. /ngc/projects2/gm/data/archive/2022/variants/snv/58psthanm-103915637522-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01774-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05608_22RKG011019_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='58pst')
    has_data = 1
