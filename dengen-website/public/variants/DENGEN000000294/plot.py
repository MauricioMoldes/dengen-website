...
#   plot-vcfstats -p /mnt/dengen/results/outdir/46sisitam-110308176022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02391-221118_A00559_BHF53GDSX5-EXT_LABKA_NGCWGS-NGCWGS06321 /mnt/dengen/results/stats/46sisitam-110308176022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02391-221118_A00559_BHF53GDSX5-EXT_LABKA_NGCWGS-NGCWGS06321_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 46sis .. /ngc/projects2/gm/data/archive/2022/variants/snv/46sisitam-110308176022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02391-221118_A00559_BHF53GDSX5-EXT_LABKA_NGCWGS-NGCWGS06321_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='46sis')
    has_data = 1
