...
#   plot-vcfstats -p /mnt/dengen/results/outdir/89aterraf-110297316897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221014_A00559_BH3FK3DSX5-RHGM_LABKA_WGSAKUT-WGSAKUT05833_22RKG024433x01 /mnt/dengen/results/stats/89aterraf-110297316897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221014_A00559_BH3FK3DSX5-RHGM_LABKA_WGSAKUT-WGSAKUT05833_22RKG024433x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 89ate .. /ngc/projects2/gm/data/archive/2022/variants/snv/89aterraf-110297316897-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221014_A00559_BH3FK3DSX5-RHGM_LABKA_WGSAKUT-WGSAKUT05833_22RKG024433x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='89ate')
    has_data = 1
