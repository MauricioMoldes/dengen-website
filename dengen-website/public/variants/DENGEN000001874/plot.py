...
#   plot-vcfstats -p /mnt/dengen/results/outdir/90othensm-103838812543-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00605-220225_A01176_AH7CT5DSX3-EXT_LABKA_NGCWGS-NGCWGS03882 /mnt/dengen/results/stats/90othensm-103838812543-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00605-220225_A01176_AH7CT5DSX3-EXT_LABKA_NGCWGS-NGCWGS03882_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 90oth .. /ngc/projects2/gm/data/archive/2022/variants/snv/90othensm-103838812543-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00605-220225_A01176_AH7CT5DSX3-EXT_LABKA_NGCWGS-NGCWGS03882_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='90oth')
    has_data = 1
