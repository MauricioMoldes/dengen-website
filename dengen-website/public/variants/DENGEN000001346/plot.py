...
#   plot-vcfstats -p /mnt/dengen/results/outdir/83ftiform-103889589507-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01559-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05360_22RKG016642 /mnt/dengen/results/stats/83ftiform-103889589507-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01559-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05360_22RKG016642_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 83fti .. /ngc/projects2/gm/data/archive/2022/variants/snv/83ftiform-103889589507-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01559-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05360_22RKG016642_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='83fti')
    has_data = 1
