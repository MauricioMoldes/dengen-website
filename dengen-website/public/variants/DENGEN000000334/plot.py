...
#   plot-vcfstats -p /mnt/dengen/results/outdir/52avemitf-110299343280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02121-221026_A00559_BH3MJVDSX5-EXT_LABKA_NGCWGS-NGCWGS05996 /mnt/dengen/results/stats/52avemitf-110299343280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02121-221026_A00559_BH3MJVDSX5-EXT_LABKA_NGCWGS-NGCWGS05996_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 52ave .. /ngc/projects2/gm/data/archive/2022/variants/snv/52avemitf-110299343280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02121-221026_A00559_BH3MJVDSX5-EXT_LABKA_NGCWGS-NGCWGS05996_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='52ave')
    has_data = 1
