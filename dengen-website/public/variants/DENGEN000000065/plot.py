...
#   plot-vcfstats -p /mnt/dengen/results/outdir/06prericm-110301968519-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_AH3N22DSX5-RHGM_LABKA_WGS-WGS06055 /mnt/dengen/results/stats/06prericm-110301968519-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_AH3N22DSX5-RHGM_LABKA_WGS-WGS06055_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 06pre .. /ngc/projects2/gm/data/archive/2022/variants/snv/06prericm-110301968519-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221102_A01411_AH3N22DSX5-RHGM_LABKA_WGS-WGS06055_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='06pre')
    has_data = 1
