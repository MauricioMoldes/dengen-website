...
#   plot-vcfstats -p /mnt/dengen/results/outdir/52ethhecm-110294083875-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01979-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05797 /mnt/dengen/results/stats/52ethhecm-110294083875-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01979-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05797_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 52eth .. /ngc/projects2/gm/data/archive/2022/variants/snv/52ethhecm-110294083875-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01979-221012_A00559_BH2CMWDSX5-EXT_LABKA_NGCWGS-NGCWGS05797_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='52eth')
    has_data = 1
