...
#   plot-vcfstats -p /mnt/dengen/results/outdir/20melingf-103867832123-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01723-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05484_22RKG011316 /mnt/dengen/results/stats/20melingf-103867832123-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01723-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05484_22RKG011316_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 20mel .. /ngc/projects2/gm/data/archive/2022/variants/snv/20melingf-103867832123-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01723-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05484_22RKG011316_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='20mel')
    has_data = 1
