...
#   plot-vcfstats -p /mnt/dengen/results/outdir/87ithconf-103794006176-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00386-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00285_21RKG024572x01 /mnt/dengen/results/stats/87ithconf-103794006176-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00386-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00285_21RKG024572x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 87ith .. /ngc/projects2/gm/data/archive/2022/variants/snv/87ithconf-103794006176-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00386-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00285_21RKG024572x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='87ith')
    has_data = 1
