...
#   plot-vcfstats -p /mnt/dengen/results/outdir/51dftstrf-103801135157-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211110_A01411_AHT7VJDSX2-RHGM_LABKA_WGS-WGS03305 /mnt/dengen/results/stats/51dftstrf-103801135157-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211110_A01411_AHT7VJDSX2-RHGM_LABKA_WGS-WGS03305_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 51dft .. /ngc/projects2/gm/data/archive/2022/variants/snv/51dftstrf-103801135157-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211110_A01411_AHT7VJDSX2-RHGM_LABKA_WGS-WGS03305_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='51dft')
    has_data = 1
