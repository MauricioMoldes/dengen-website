...
#   plot-vcfstats -p /mnt/dengen/results/outdir/62lehegam-103895724232-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01481-220914_A01176_AHTNVGDSX3-EXT_LABKA_NGCWGS-NGCWGS05255_22RKG018277 /mnt/dengen/results/stats/62lehegam-103895724232-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01481-220914_A01176_AHTNVGDSX3-EXT_LABKA_NGCWGS-NGCWGS05255_22RKG018277_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 62leh .. /ngc/projects2/gm/data/archive/2022/variants/snv/62lehegam-103895724232-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01481-220914_A01176_AHTNVGDSX3-EXT_LABKA_NGCWGS-NGCWGS05255_22RKG018277_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='62leh')
    has_data = 1
