...
#   plot-vcfstats -p /mnt/dengen/results/outdir/63retheem-110306377080-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02351-221116_A01176_AHF53VDSX5-EXT_LABKA_NGCWGS-NGCWGS06248 /mnt/dengen/results/stats/63retheem-110306377080-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02351-221116_A01176_AHF53VDSX5-EXT_LABKA_NGCWGS-NGCWGS06248_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 63ret .. /ngc/projects2/gm/data/archive/2022/variants/snv/63retheem-110306377080-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02351-221116_A01176_AHF53VDSX5-EXT_LABKA_NGCWGS-NGCWGS06248_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='63ret')
    has_data = 1
