...
#   plot-vcfstats -p /mnt/dengen/results/outdir/56tidancm-110296842536-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02021-221019_A01176_BH3FN7DSX5-EXT_LABKA_NGCWGS-NGCWGS05895 /mnt/dengen/results/stats/56tidancm-110296842536-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02021-221019_A01176_BH3FN7DSX5-EXT_LABKA_NGCWGS-NGCWGS05895_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 56tid .. /ngc/projects2/gm/data/archive/2022/variants/snv/56tidancm-110296842536-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02021-221019_A01176_BH3FN7DSX5-EXT_LABKA_NGCWGS-NGCWGS05895_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='56tid')
    has_data = 1
