...
#   plot-vcfstats -p /mnt/dengen/results/outdir/81toithaf-110300427719-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02196-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06046 /mnt/dengen/results/stats/81toithaf-110300427719-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02196-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06046_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 81toi .. /ngc/projects2/gm/data/archive/2022/variants/snv/81toithaf-110300427719-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02196-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06046_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='81toi')
    has_data = 1
