...
#   plot-vcfstats -p /mnt/dengen/results/outdir/42fombatm-110294762012-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02072-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05851 /mnt/dengen/results/stats/42fombatm-110294762012-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02072-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05851_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 42fom .. /ngc/projects2/gm/data/archive/2022/variants/snv/42fombatm-110294762012-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02072-221019_A00559_AH33JKDSX5-EXT_LABKA_NGCWGS-NGCWGS05851_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='42fom')
    has_data = 1
