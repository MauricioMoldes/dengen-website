...
#   plot-vcfstats -p /mnt/dengen/results/outdir/51tthtisf-103909053166-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01386-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05151_22RKG019013 /mnt/dengen/results/stats/51tthtisf-103909053166-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01386-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05151_22RKG019013_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 51tth .. /ngc/projects2/gm/data/archive/2022/variants/snv/51tthtisf-103909053166-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01386-220912_A01961_AHYT5NDSX3-EXT_LABKA_NGCWGS-NGCWGS05151_22RKG019013_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='51tth')
    has_data = 1
