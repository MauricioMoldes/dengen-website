...
#   plot-vcfstats -p /mnt/dengen/results/outdir/57dthardf-103892158430-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01613-220921_A00559_AHYM7WDSX3-EXT_LABKA_NGCWGS-NGCWGS05403_22RKG017439 /mnt/dengen/results/stats/57dthardf-103892158430-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01613-220921_A00559_AHYM7WDSX3-EXT_LABKA_NGCWGS-NGCWGS05403_22RKG017439_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 57dth .. /ngc/projects2/gm/data/archive/2022/variants/snv/57dthardf-103892158430-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01613-220921_A00559_AHYM7WDSX3-EXT_LABKA_NGCWGS-NGCWGS05403_22RKG017439_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='57dth')
    has_data = 1
