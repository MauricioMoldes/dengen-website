...
#   plot-vcfstats -p /mnt/dengen/results/outdir/70icelwam-103904474201-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01169-220824_A01961_BHMWKTDSX3-EXT_LABKA_NGCWGS-NGCWGS04920_22RKG002294x01 /mnt/dengen/results/stats/70icelwam-103904474201-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01169-220824_A01961_BHMWKTDSX3-EXT_LABKA_NGCWGS-NGCWGS04920_22RKG002294x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 70ice .. /ngc/projects2/gm/data/archive/2022/variants/snv/70icelwam-103904474201-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01169-220824_A01961_BHMWKTDSX3-EXT_LABKA_NGCWGS-NGCWGS04920_22RKG002294x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='70ice')
    has_data = 1
