...
#   plot-vcfstats -p /mnt/dengen/results/outdir/02esaldem-110305198238-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02361-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06261 /mnt/dengen/results/stats/02esaldem-110305198238-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02361-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06261_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 02esa .. /ngc/projects2/gm/data/archive/2022/variants/snv/02esaldem-110305198238-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02361-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06261_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='02esa')
    has_data = 1
