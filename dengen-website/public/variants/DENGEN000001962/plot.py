...
#   plot-vcfstats -p /mnt/dengen/results/outdir/92cckitbm-103895687116-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01174-220831_A01961_AHTNYGDSX3-EXT_LABKA_NGCWGS-NGCWGS04930 /mnt/dengen/results/stats/92cckitbm-103895687116-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01174-220831_A01961_AHTNYGDSX3-EXT_LABKA_NGCWGS-NGCWGS04930_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 92cck .. /ngc/projects2/gm/data/archive/2022/variants/snv/92cckitbm-103895687116-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01174-220831_A01961_AHTNYGDSX3-EXT_LABKA_NGCWGS-NGCWGS04930_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='92cck')
    has_data = 1
