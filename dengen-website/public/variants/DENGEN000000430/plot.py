...
#   plot-vcfstats -p /mnt/dengen/results/outdir/59heniedf-110303018470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02330-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06218 /mnt/dengen/results/stats/59heniedf-110303018470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02330-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06218_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 59hen .. /ngc/projects2/gm/data/archive/2022/variants/snv/59heniedf-110303018470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02330-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06218_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='59hen')
    has_data = 1
