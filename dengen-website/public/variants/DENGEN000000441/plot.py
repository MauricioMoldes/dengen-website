...
#   plot-vcfstats -p /mnt/dengen/results/outdir/60arimaim-103794072586-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00390-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00289_21RKG022821x01 /mnt/dengen/results/stats/60arimaim-103794072586-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00390-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00289_21RKG022821x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 60ari .. /ngc/projects2/gm/data/archive/2022/variants/snv/60arimaim-103794072586-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00390-211026_A01411_AHN23JDSX2-EXT_LABKA_NGCWGS-NGCWGS00289_21RKG022821x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='60ari')
    has_data = 1
