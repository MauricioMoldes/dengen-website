...
#   plot-vcfstats -p /mnt/dengen/results/outdir/81inwanam-110307304361-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06228_22RKG026926x01 /mnt/dengen/results/stats/81inwanam-110307304361-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06228_22RKG026926x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 81inw .. /ngc/projects2/gm/data/archive/2022/variants/snv/81inwanam-110307304361-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06228_22RKG026926x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='81inw')
    has_data = 1
