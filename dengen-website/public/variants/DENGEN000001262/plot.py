...
#   plot-vcfstats -p /mnt/dengen/results/outdir/82althomf-110307302822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06224_22RKG026934x01 /mnt/dengen/results/stats/82althomf-110307302822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06224_22RKG026934x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 82alt .. /ngc/projects2/gm/data/archive/2022/variants/snv/82althomf-110307302822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-221116_A00559_BHF53WDSX5-RHGM_LABKA_WGSAKUT-WGSAKUT06224_22RKG026934x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='82alt')
    has_data = 1
