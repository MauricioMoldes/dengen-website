...
#   plot-vcfstats -p /mnt/dengen/results/outdir/11andricm-103856192969-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220407_A01411_AHGNYMDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04065_22RKG007988x01 /mnt/dengen/results/stats/11andricm-103856192969-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220407_A01411_AHGNYMDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04065_22RKG007988x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 11and .. /ngc/projects2/gm/data/archive/2022/variants/snv/11andricm-103856192969-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220407_A01411_AHGNYMDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04065_22RKG007988x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='11and')
    has_data = 1
