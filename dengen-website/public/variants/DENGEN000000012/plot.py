...
#   plot-vcfstats -p /mnt/dengen/results/outdir/01insadsf-103802113939-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03338 /mnt/dengen/results/stats/01insadsf-103802113939-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03338_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 01ins .. /ngc/projects2/gm/data/archive/2022/variants/snv/01insadsf-103802113939-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211117_A01411_BHT773DSX2-RHGM_LABKA_WGS-WGS03338_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='01ins')
    has_data = 1
