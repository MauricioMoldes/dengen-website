...
#   plot-vcfstats -p /mnt/dengen/results/outdir/84rsedcef-103907613342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01247-220907_A01176_AHYN73DSX3-EXT_LABKA_NGCWGS-NGCWGS05019_22RKG011084x01 /mnt/dengen/results/stats/84rsedcef-103907613342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01247-220907_A01176_AHYN73DSX3-EXT_LABKA_NGCWGS-NGCWGS05019_22RKG011084x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 84rse .. /ngc/projects2/gm/data/archive/2022/variants/snv/84rsedcef-103907613342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01247-220907_A01176_AHYN73DSX3-EXT_LABKA_NGCWGS-NGCWGS05019_22RKG011084x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='84rse')
    has_data = 1
