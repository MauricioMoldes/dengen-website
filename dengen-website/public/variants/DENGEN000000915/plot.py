...
#   plot-vcfstats -p /mnt/dengen/results/outdir/76chonyhf-103794070125-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00357-211019_A01411_BHHHY3DSX2-EXT_LABKA_NGCWGS-NGCWGS00256_21RKG022879x01 /mnt/dengen/results/stats/76chonyhf-103794070125-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00357-211019_A01411_BHHHY3DSX2-EXT_LABKA_NGCWGS-NGCWGS00256_21RKG022879x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 76cho .. /ngc/projects2/gm/data/archive/2022/variants/snv/76chonyhf-103794070125-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00357-211019_A01411_BHHHY3DSX2-EXT_LABKA_NGCWGS-NGCWGS00256_21RKG022879x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='76cho')
    has_data = 1
