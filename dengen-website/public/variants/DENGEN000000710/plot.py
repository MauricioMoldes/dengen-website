...
#   plot-vcfstats -p /mnt/dengen/results/outdir/70wocothm-103895021118-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01603-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05351_22RKG018102 /mnt/dengen/results/stats/70wocothm-103895021118-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01603-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05351_22RKG018102_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 70woc .. /ngc/projects2/gm/data/archive/2022/variants/snv/70wocothm-103895021118-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01603-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05351_22RKG018102_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='70woc')
    has_data = 1
