...
#   plot-vcfstats -p /mnt/dengen/results/outdir/20sosthem-103881960508-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00909-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04509 /mnt/dengen/results/stats/20sosthem-103881960508-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00909-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04509_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 20sos .. /ngc/projects2/gm/data/archive/2022/variants/snv/20sosthem-103881960508-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00909-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04509_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='20sos')
    has_data = 1
