...
#   plot-vcfstats -p /mnt/dengen/results/outdir/55ngstytf-103914466180-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01761-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05625_22RKG013630 /mnt/dengen/results/stats/55ngstytf-103914466180-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01761-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05625_22RKG013630_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 55ngs .. /ngc/projects2/gm/data/archive/2022/variants/snv/55ngstytf-103914466180-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01761-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05625_22RKG013630_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='55ngs')
    has_data = 1
