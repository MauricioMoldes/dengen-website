...
#   plot-vcfstats -p /mnt/dengen/results/outdir/48pangctf-110301309280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02189-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06039 /mnt/dengen/results/stats/48pangctf-110301309280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02189-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06039_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 48pan .. /ngc/projects2/gm/data/archive/2022/variants/snv/48pangctf-110301309280-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02189-221102_A01176_BH3TYFDSX5-EXT_LABKA_NGCWGS-NGCWGS06039_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='48pan')
    has_data = 1
