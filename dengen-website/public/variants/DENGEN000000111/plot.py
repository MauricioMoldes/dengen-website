...
#   plot-vcfstats -p /mnt/dengen/results/outdir/10thfrasm-110304935107-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02362-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06262 /mnt/dengen/results/stats/10thfrasm-110304935107-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02362-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06262_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 10thf .. /ngc/projects2/gm/data/archive/2022/variants/snv/10thfrasm-110304935107-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02362-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06262_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='10thf')
    has_data = 1
