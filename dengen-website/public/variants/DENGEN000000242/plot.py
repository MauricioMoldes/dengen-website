...
#   plot-vcfstats -p /mnt/dengen/results/outdir/22nithadf-103880783645-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04473_22RKG014060x01 /mnt/dengen/results/stats/22nithadf-103880783645-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04473_22RKG014060x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 22nit .. /ngc/projects2/gm/data/archive/2022/variants/snv/22nithadf-103880783645-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04473_22RKG014060x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='22nit')
    has_data = 1
