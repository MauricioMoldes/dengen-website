...
#   plot-vcfstats -p /mnt/dengen/results/outdir/50epaygpf-103870422160-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220518_A01411_AHJ5W2DSX3-RHGM_LABKA_WGS-WGS04284 /mnt/dengen/results/stats/50epaygpf-103870422160-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220518_A01411_AHJ5W2DSX3-RHGM_LABKA_WGS-WGS04284_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 50epa .. /ngc/projects2/gm/data/archive/2022/variants/snv/50epaygpf-103870422160-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220518_A01411_AHJ5W2DSX3-RHGM_LABKA_WGS-WGS04284_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='50epa')
    has_data = 1
