...
#   plot-vcfstats -p /mnt/dengen/results/outdir/07crttonm-110302539328-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02261-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06146_20RKG005221 /mnt/dengen/results/stats/07crttonm-110302539328-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02261-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06146_20RKG005221_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 07crt .. /ngc/projects2/gm/data/archive/2022/variants/snv/07crttonm-110302539328-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02261-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06146_20RKG005221_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='07crt')
    has_data = 1
