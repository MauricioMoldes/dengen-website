...
#   plot-vcfstats -p /mnt/dengen/results/outdir/06thckirm-103898386001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220817_A01411_AHNVWWDSX3-RHGM_LABKA_WGS-WGS04831 /mnt/dengen/results/stats/06thckirm-103898386001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220817_A01411_AHNVWWDSX3-RHGM_LABKA_WGS-WGS04831_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 06thc .. /ngc/projects2/gm/data/archive/2022/variants/snv/06thckirm-103898386001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220817_A01411_AHNVWWDSX3-RHGM_LABKA_WGS-WGS04831_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='06thc')
    has_data = 1
