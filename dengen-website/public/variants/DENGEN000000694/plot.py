...
#   plot-vcfstats -p /mnt/dengen/results/outdir/70clstitm-103880399136-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00910-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04514_22RKG005924x01 /mnt/dengen/results/stats/70clstitm-103880399136-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00910-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04514_22RKG005924x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 70cls .. /ngc/projects2/gm/data/archive/2022/variants/snv/70clstitm-103880399136-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00910-220622_A00559_AHKCKKDSX3-EXT_LABKA_NGCWGS-NGCWGS04514_22RKG005924x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='70cls')
    has_data = 1
