...
#   plot-vcfstats -p /mnt/dengen/results/outdir/07wntvetf-103880596764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00970-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04567_22RKG013977x01 /mnt/dengen/results/stats/07wntvetf-103880596764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00970-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04567_22RKG013977x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 07wnt .. /ngc/projects2/gm/data/archive/2022/variants/snv/07wntvetf-103880596764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00970-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04567_22RKG013977x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='07wnt')
    has_data = 1
