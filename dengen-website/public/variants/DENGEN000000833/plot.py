...
#   plot-vcfstats -p /mnt/dengen/results/outdir/74ergwham-110300125356-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02168-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06051 /mnt/dengen/results/stats/74ergwham-110300125356-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02168-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06051_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 74erg .. /ngc/projects2/gm/data/archive/2022/variants/snv/74ergwham-110300125356-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02168-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06051_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='74erg')
    has_data = 1
