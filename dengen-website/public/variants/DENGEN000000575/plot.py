...
#   plot-vcfstats -p /mnt/dengen/results/outdir/66boreref-103760986321-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00279-210720_A01411_BHGMTTDSX2-EXT_LABKA_NGCWGS-NGCWGS00172_666hwrqj2 /mnt/dengen/results/stats/66boreref-103760986321-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00279-210720_A01411_BHGMTTDSX2-EXT_LABKA_NGCWGS-NGCWGS00172_666hwrqj2_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 66bor .. /ngc/projects2/gm/data/archive/2022/variants/snv/66boreref-103760986321-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00279-210720_A01411_BHGMTTDSX2-EXT_LABKA_NGCWGS-NGCWGS00172_666hwrqj2_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='66bor')
    has_data = 1
