...
#   plot-vcfstats -p /mnt/dengen/results/outdir/19brediaf-103847733243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00674-220323_A00559_AHCGFCDSX3-EXT_LABKA_NGCWGS-NGCWGS04023_22RKG002599x01 /mnt/dengen/results/stats/19brediaf-103847733243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00674-220323_A00559_AHCGFCDSX3-EXT_LABKA_NGCWGS-NGCWGS04023_22RKG002599x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 19bre .. /ngc/projects2/gm/data/archive/2022/variants/snv/19brediaf-103847733243-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00674-220323_A00559_AHCGFCDSX3-EXT_LABKA_NGCWGS-NGCWGS04023_22RKG002599x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='19bre')
    has_data = 1
