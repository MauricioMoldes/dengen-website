...
#   plot-vcfstats -p /mnt/dengen/results/outdir/08pparorf-103908337756-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01590-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05202 /mnt/dengen/results/stats/08pparorf-103908337756-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01590-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05202_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 08ppa .. /ngc/projects2/gm/data/archive/2022/variants/snv/08pparorf-103908337756-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01590-220916_A01176_BHYT22DSX3-EXT_LABKA_NGCWGS-NGCWGS05202_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='08ppa')
    has_data = 1
