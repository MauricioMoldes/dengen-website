...
#   plot-vcfstats -p /mnt/dengen/results/outdir/11sinongm-103910558675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01462-220914_A01411_AHTNL5DSX3-EXT_LABKA_NGCWGS-NGCWGS05236 /mnt/dengen/results/stats/11sinongm-103910558675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01462-220914_A01411_AHTNL5DSX3-EXT_LABKA_NGCWGS-NGCWGS05236_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 11sin .. /ngc/projects2/gm/data/archive/2022/variants/snv/11sinongm-103910558675-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01462-220914_A01411_AHTNL5DSX3-EXT_LABKA_NGCWGS-NGCWGS05236_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='11sin')
    has_data = 1
