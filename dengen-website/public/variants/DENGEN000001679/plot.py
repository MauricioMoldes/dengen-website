...
#   plot-vcfstats -p /mnt/dengen/results/outdir/88aisalof-103909039015-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01302-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05080_22RKG010554 /mnt/dengen/results/stats/88aisalof-103909039015-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01302-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05080_22RKG010554_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 88ais .. /ngc/projects2/gm/data/archive/2022/variants/snv/88aisalof-103909039015-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01302-220909_A00559_BHY2MJDSX3-EXT_LABKA_NGCWGS-NGCWGS05080_22RKG010554_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='88ais')
    has_data = 1
