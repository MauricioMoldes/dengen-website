...
#   plot-vcfstats -p /mnt/dengen/results/outdir/20ttrepem-103836016464-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00620-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03898_21RKG031801x01 /mnt/dengen/results/stats/20ttrepem-103836016464-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00620-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03898_21RKG031801x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 20ttr .. /ngc/projects2/gm/data/archive/2022/variants/snv/20ttrepem-103836016464-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00620-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03898_21RKG031801x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='20ttr')
    has_data = 1
