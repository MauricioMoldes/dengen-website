...
#   plot-vcfstats -p /mnt/dengen/results/outdir/06otiripm-103909046194-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01329-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05107_22RKG016092 /mnt/dengen/results/stats/06otiripm-103909046194-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01329-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05107_22RKG016092_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 06oti .. /ngc/projects2/gm/data/archive/2022/variants/snv/06otiripm-103909046194-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01329-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05107_22RKG016092_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='06oti')
    has_data = 1
