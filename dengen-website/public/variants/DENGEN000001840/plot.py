...
#   plot-vcfstats -p /mnt/dengen/results/outdir/90apawatm-103899193860-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01514-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05307_22RKG019059 /mnt/dengen/results/stats/90apawatm-103899193860-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01514-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05307_22RKG019059_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 90apa .. /ngc/projects2/gm/data/archive/2022/variants/snv/90apawatm-103899193860-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01514-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05307_22RKG019059_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='90apa')
    has_data = 1
