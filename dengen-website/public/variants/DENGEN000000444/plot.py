...
#   plot-vcfstats -p /mnt/dengen/results/outdir/60gaagthf-103910908170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01551-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05394 /mnt/dengen/results/stats/60gaagthf-103910908170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01551-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05394_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 60gaa .. /ngc/projects2/gm/data/archive/2022/variants/snv/60gaagthf-103910908170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01551-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05394_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='60gaa')
    has_data = 1
