...
#   plot-vcfstats -p /mnt/dengen/results/outdir/72eagrerm-103873955355-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00846-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04393 /mnt/dengen/results/stats/72eagrerm-103873955355-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00846-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04393_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 72eag .. /ngc/projects2/gm/data/archive/2022/variants/snv/72eagrerm-103873955355-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00846-220603_A01411_BHJ5NYDSX3-EXT_LABKA_NGCWGS-NGCWGS04393_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='72eag')
    has_data = 1
