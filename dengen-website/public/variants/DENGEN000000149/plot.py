...
#   plot-vcfstats -p /mnt/dengen/results/outdir/16indfotm-103915641538-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01775-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05609_22RKG012622 /mnt/dengen/results/stats/16indfotm-103915641538-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01775-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05609_22RKG012622_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 16ind .. /ngc/projects2/gm/data/archive/2022/variants/snv/16indfotm-103915641538-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01775-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05609_22RKG012622_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='16ind')
    has_data = 1
