...
#   plot-vcfstats -p /mnt/dengen/results/outdir/69witmasf-103886444834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00980-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04589 /mnt/dengen/results/stats/69witmasf-103886444834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00980-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04589_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 69wit .. /ngc/projects2/gm/data/archive/2022/variants/snv/69witmasf-103886444834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00980-220706_A01176_AHKCJ2DSX3-EXT_LABKA_NGCWGS-NGCWGS04589_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='69wit')
    has_data = 1
