...
#   plot-vcfstats -p /mnt/dengen/results/outdir/12dhedeaf-103864864644-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00800-220525_A00559_BHJ5JJDSX3-EXT_LABKA_NGCWGS-NGCWGS04306 /mnt/dengen/results/stats/12dhedeaf-103864864644-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00800-220525_A00559_BHJ5JJDSX3-EXT_LABKA_NGCWGS-NGCWGS04306_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 12dhe .. /ngc/projects2/gm/data/archive/2022/variants/snv/12dhedeaf-103864864644-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00800-220525_A00559_BHJ5JJDSX3-EXT_LABKA_NGCWGS-NGCWGS04306_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='12dhe')
    has_data = 1
