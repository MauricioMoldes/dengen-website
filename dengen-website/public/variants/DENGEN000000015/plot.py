...
#   plot-vcfstats -p /mnt/dengen/results/outdir/01orlyicm-103816076585-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211215_A01466_BH2GHYDSX3-RHGM_LABKA_WGS-WGS03519 /mnt/dengen/results/stats/01orlyicm-103816076585-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211215_A01466_BH2GHYDSX3-RHGM_LABKA_WGS-WGS03519_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 01orl .. /ngc/projects2/gm/data/archive/2022/variants/snv/01orlyicm-103816076585-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211215_A01466_BH2GHYDSX3-RHGM_LABKA_WGS-WGS03519_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='01orl')
    has_data = 1
