...
#   plot-vcfstats -p /mnt/dengen/results/outdir/15thfoamm-103909046470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01347-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05125_22RKG015231 /mnt/dengen/results/stats/15thfoamm-103909046470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01347-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05125_22RKG015231_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 15thf .. /ngc/projects2/gm/data/archive/2022/variants/snv/15thfoamm-103909046470-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01347-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05125_22RKG015231_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='15thf')
    has_data = 1
