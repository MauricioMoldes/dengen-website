...
#   plot-vcfstats -p /mnt/dengen/results/outdir/56ftalerf-103782976175-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211103_A01466_BHT575DSX2-RHGM_LABKA_WGS-WGS03285 /mnt/dengen/results/stats/56ftalerf-103782976175-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211103_A01466_BHT575DSX2-RHGM_LABKA_WGS-WGS03285_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 56fta .. /ngc/projects2/gm/data/archive/2022/variants/snv/56ftalerf-103782976175-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211103_A01466_BHT575DSX2-RHGM_LABKA_WGS-WGS03285_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='56fta')
    has_data = 1
