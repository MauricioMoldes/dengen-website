...
#   plot-vcfstats -p /mnt/dengen/results/outdir/66psemapm-110303676027-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02252-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06137 /mnt/dengen/results/stats/66psemapm-110303676027-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02252-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06137_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 66pse .. /ngc/projects2/gm/data/archive/2022/variants/snv/66psemapm-110303676027-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02252-221109_A01411_AH3NKCDSX5-EXT_LABKA_NGCWGS-NGCWGS06137_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='66pse')
    has_data = 1
