...
#   plot-vcfstats -p /mnt/dengen/results/outdir/71arthanf-103909551816-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01430-220912_A01411_BHYMNTDSX3-EXT_LABKA_NGCWGS-NGCWGS05209_22RKG021237x01 /mnt/dengen/results/stats/71arthanf-103909551816-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01430-220912_A01411_BHYMNTDSX3-EXT_LABKA_NGCWGS-NGCWGS05209_22RKG021237x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 71art .. /ngc/projects2/gm/data/archive/2022/variants/snv/71arthanf-103909551816-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01430-220912_A01411_BHYMNTDSX3-EXT_LABKA_NGCWGS-NGCWGS05209_22RKG021237x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='71art')
    has_data = 1
