...
& \multicolumn{1}{>{\columncolor{hcol2}}c}{} \\ \hline
         63per & 4,127,072 & 1.92 & 1.92 & 964,568 & -- & 0 & 0 \\ 
%
     ...
     63per & 62.9\% & 1.89 & 68.5\% & 105,925 &2,238 \\ 
 \end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
        \item 63per .. \texttt{\footnotesize /ngc/projects2/gm/data/archive/2022/variants/snv/63perwisf-103900092010-Normal\_B\\\hskip2em lood\_noinfo-WGS\_v1\_IlluminaDNAPCRFree\_X-220817\_A00559\_BHNVWTDSX3-RHGM\_LABKA\_WGS-\\\hskip2em WGS04830\_snv\_germline\_raw.haplotype\_caller.vcf.gz}
