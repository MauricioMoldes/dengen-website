...
#   plot-vcfstats -p /mnt/dengen/results/outdir/56sftrawm-110307183742-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02372-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06272 /mnt/dengen/results/stats/56sftrawm-110307183742-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02372-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06272_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 56sft .. /ngc/projects2/gm/data/archive/2022/variants/snv/56sftrawm-110307183742-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02372-221116_A01176_BHCYHYDSX5-EXT_LABKA_NGCWGS-NGCWGS06272_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='56sft')
    has_data = 1
