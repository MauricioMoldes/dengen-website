...
#   plot-vcfstats -p /mnt/dengen/results/outdir/73puleeam-103906305342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01726-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05487_22RKG020883 /mnt/dengen/results/stats/73puleeam-103906305342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01726-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05487_22RKG020883_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 73pul .. /ngc/projects2/gm/data/archive/2022/variants/snv/73puleeam-103906305342-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01726-220923_A01176_AHTNY2DSX3-EXT_LABKA_NGCWGS-NGCWGS05487_22RKG020883_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='73pul')
    has_data = 1
