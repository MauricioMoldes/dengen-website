...
#
# Title abbreviations:
# 	 0 .. 71cof .. /ngc/projects2/gm/data/archive/2022/variants/snv/71cofverm-103815072020-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211217_A01411_BHHJ3KDSX2-RHGM_LABKA_WGS-WGS03506_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='71cof')
    has_data = 1
