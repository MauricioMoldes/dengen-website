...
#   plot-vcfstats -p /mnt/dengen/results/outdir/01torebef-103906972608-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01731-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05492_22RKG020979 /mnt/dengen/results/stats/01torebef-103906972608-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01731-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05492_22RKG020979_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 01tor .. /ngc/projects2/gm/data/archive/2022/variants/snv/01torebef-103906972608-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01731-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05492_22RKG020979_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='01tor')
    has_data = 1
