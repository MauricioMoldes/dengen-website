...
#   plot-vcfstats -p /mnt/dengen/results/outdir/78cugoblm-110301124205-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02166-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06049 /mnt/dengen/results/stats/78cugoblm-110301124205-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02166-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06049_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 78cug .. /ngc/projects2/gm/data/archive/2022/variants/snv/78cugoblm-110301124205-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02166-221102_A01411_AH3N22DSX5-EXT_LABKA_NGCWGS-NGCWGS06049_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='78cug')
    has_data = 1
