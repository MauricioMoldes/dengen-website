...
#   plot-vcfstats -p /mnt/dengen/results/outdir/65uspandf-103913321994-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220923_A01961_AH33KNDSX5-RHGM_LABKA_WGS-WGS05522 /mnt/dengen/results/stats/65uspandf-103913321994-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220923_A01961_AH33KNDSX5-RHGM_LABKA_WGS-WGS05522_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 65usp .. /ngc/projects2/gm/data/archive/2022/variants/snv/65uspandf-103913321994-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220923_A01961_AH33KNDSX5-RHGM_LABKA_WGS-WGS05522_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='65usp')
    has_data = 1
