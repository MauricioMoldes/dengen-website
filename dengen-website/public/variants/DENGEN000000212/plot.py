...
#   plot-vcfstats -p /mnt/dengen/results/outdir/21chetavm-103909048812-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01353-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05131_22RKG012930 /mnt/dengen/results/stats/21chetavm-103909048812-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01353-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05131_22RKG012930_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 21che .. /ngc/projects2/gm/data/archive/2022/variants/snv/21chetavm-103909048812-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01353-220909_A01961_BHY2CGDSX3-EXT_LABKA_NGCWGS-NGCWGS05131_22RKG012930_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='21che')
    has_data = 1
