...
#   plot-vcfstats -p /mnt/dengen/results/outdir/16puiethm-103907168950-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01378-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05175_21RKG002677x01 /mnt/dengen/results/stats/16puiethm-103907168950-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01378-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05175_21RKG002677x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 16pui .. /ngc/projects2/gm/data/archive/2022/variants/snv/16puiethm-103907168950-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01378-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05175_21RKG002677x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='16pui')
    has_data = 1
