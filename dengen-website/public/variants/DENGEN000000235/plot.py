...
#   plot-vcfstats -p /mnt/dengen/results/outdir/22erondrf-103863056811-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220427_A01411_AHJ5CLDSX3-RHGM_LABKA_WGS-WGS04182 /mnt/dengen/results/stats/22erondrf-103863056811-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220427_A01411_AHJ5CLDSX3-RHGM_LABKA_WGS-WGS04182_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 22ero .. /ngc/projects2/gm/data/archive/2022/variants/snv/22erondrf-103863056811-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220427_A01411_AHJ5CLDSX3-RHGM_LABKA_WGS-WGS04182_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='22ero')
    has_data = 1
