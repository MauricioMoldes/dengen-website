...
#   plot-vcfstats -p /mnt/dengen/results/outdir/81atsherm-103907166001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01207-220902_A01961_BHWKC7DSX3-EXT_LABKA_NGCWGS-NGCWGS04979_18RKG020840x01 /mnt/dengen/results/stats/81atsherm-103907166001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01207-220902_A01961_BHWKC7DSX3-EXT_LABKA_NGCWGS-NGCWGS04979_18RKG020840x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 81ats .. /ngc/projects2/gm/data/archive/2022/variants/snv/81atsherm-103907166001-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01207-220902_A01961_BHWKC7DSX3-EXT_LABKA_NGCWGS-NGCWGS04979_18RKG020840x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='81ats')
    has_data = 1
