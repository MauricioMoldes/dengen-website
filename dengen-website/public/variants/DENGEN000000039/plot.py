...
#   plot-vcfstats -p /mnt/dengen/results/outdir/04ivatbef-103911275316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01549-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05392 /mnt/dengen/results/stats/04ivatbef-103911275316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01549-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05392_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 04iva .. /ngc/projects2/gm/data/archive/2022/variants/snv/04ivatbef-103911275316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01549-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05392_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='04iva')
    has_data = 1
