...
#   plot-vcfstats -p /mnt/dengen/results/outdir/92adinssf-103907809867-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01369-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05050_22RKG011833x01 /mnt/dengen/results/stats/92adinssf-103907809867-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01369-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05050_22RKG011833x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 92adi .. /ngc/projects2/gm/data/archive/2022/variants/snv/92adinssf-103907809867-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01369-220909_A00559_AHTNTWDSX3-EXT_LABKA_NGCWGS-NGCWGS05050_22RKG011833x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='92adi')
    has_data = 1
