...
#   plot-vcfstats -p /mnt/dengen/results/outdir/50sheheef-103910868763-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01538-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05380 /mnt/dengen/results/stats/50sheheef-103910868763-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01538-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05380_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 50she .. /ngc/projects2/gm/data/archive/2022/variants/snv/50sheheef-103910868763-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01538-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05380_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='50she')
    has_data = 1
