...
#   plot-vcfstats -p /mnt/dengen/results/outdir/62rlitbuf-103873847978-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00832-220601_A00559_AHJ5TYDSX3-EXT_LABKA_NGCWGS-NGCWGS04370 /mnt/dengen/results/stats/62rlitbuf-103873847978-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00832-220601_A00559_AHJ5TYDSX3-EXT_LABKA_NGCWGS-NGCWGS04370_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 62rli .. /ngc/projects2/gm/data/archive/2022/variants/snv/62rlitbuf-103873847978-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00832-220601_A00559_AHJ5TYDSX3-EXT_LABKA_NGCWGS-NGCWGS04370_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='62rli')
    has_data = 1
