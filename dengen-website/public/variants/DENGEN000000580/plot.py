...
#   plot-vcfstats -p /mnt/dengen/results/outdir/66esradef-103881081393-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00896-220615_A00559_AHJTYVDSX3-EXT_LABKA_NGCWGS-NGCWGS04466 /mnt/dengen/results/stats/66esradef-103881081393-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00896-220615_A00559_AHJTYVDSX3-EXT_LABKA_NGCWGS-NGCWGS04466_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 66esr .. /ngc/projects2/gm/data/archive/2022/variants/snv/66esradef-103881081393-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00896-220615_A00559_AHJTYVDSX3-EXT_LABKA_NGCWGS-NGCWGS04466_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='66esr')
    has_data = 1
