...
#   plot-vcfstats -p /mnt/dengen/results/outdir/02icurduf-103899118736-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01099-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04824 /mnt/dengen/results/stats/02icurduf-103899118736-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01099-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04824_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 02icu .. /ngc/projects2/gm/data/archive/2022/variants/snv/02icurduf-103899118736-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01099-220817_A00559_BHNVWTDSX3-EXT_LABKA_NGCWGS-NGCWGS04824_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='02icu')
    has_data = 1
