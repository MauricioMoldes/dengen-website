...
#   plot-vcfstats -p /mnt/dengen/results/outdir/85earedtf-103909048022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01323-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05101_22RKG014862 /mnt/dengen/results/stats/85earedtf-103909048022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01323-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05101_22RKG014862_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 85ear .. /ngc/projects2/gm/data/archive/2022/variants/snv/85earedtf-103909048022-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01323-220909_A01411_BHY2HCDSX3-EXT_LABKA_NGCWGS-NGCWGS05101_22RKG014862_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='85ear')
    has_data = 1
