...
#   plot-vcfstats -p /mnt/dengen/results/outdir/86rowatrf-103915148530-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01803-220928_A01176_AH3FNNDSX5-EXT_LABKA_NGCWGS-NGCWGS05601 /mnt/dengen/results/stats/86rowatrf-103915148530-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01803-220928_A01176_AH3FNNDSX5-EXT_LABKA_NGCWGS-NGCWGS05601_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 86row .. /ngc/projects2/gm/data/archive/2022/variants/snv/86rowatrf-103915148530-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01803-220928_A01176_AH3FNNDSX5-EXT_LABKA_NGCWGS-NGCWGS05601_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='86row')
    has_data = 1
