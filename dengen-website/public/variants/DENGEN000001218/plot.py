...
#   plot-vcfstats -p /mnt/dengen/results/outdir/81istashm-103794070834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00341-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00240_21RKG022885x01 /mnt/dengen/results/stats/81istashm-103794070834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00341-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00240_21RKG022885x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 81ist .. /ngc/projects2/gm/data/archive/2022/variants/snv/81istashm-103794070834-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00341-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00240_21RKG022885x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='81ist')
    has_data = 1
