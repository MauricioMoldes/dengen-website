...
#   plot-vcfstats -p /mnt/dengen/results/outdir/54orexthm-110302485163-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02255-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06140 /mnt/dengen/results/stats/54orexthm-110302485163-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02255-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06140_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 54ore .. /ngc/projects2/gm/data/archive/2022/variants/snv/54orexthm-110302485163-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02255-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06140_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='54ore')
    has_data = 1
