...
#   plot-vcfstats -p /mnt/dengen/results/outdir/61tsetrsm-103914492822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01789-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05623_22RKG007142 /mnt/dengen/results/stats/61tsetrsm-103914492822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01789-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05623_22RKG007142_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 61tse .. /ngc/projects2/gm/data/archive/2022/variants/snv/61tsetrsm-103914492822-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01789-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05623_22RKG007142_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='61tse')
    has_data = 1
