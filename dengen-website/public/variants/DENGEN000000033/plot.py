...
#   plot-vcfstats -p /mnt/dengen/results/outdir/02ssymenm-103844531836-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00626-220304_A01176_AHCFKFDSX3-EXT_LABKA_NGCWGS-NGCWGS03937 /mnt/dengen/results/stats/02ssymenm-103844531836-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00626-220304_A01176_AHCFKFDSX3-EXT_LABKA_NGCWGS-NGCWGS03937_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 02ssy .. /ngc/projects2/gm/data/archive/2022/variants/snv/02ssymenm-103844531836-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00626-220304_A01176_AHCFKFDSX3-EXT_LABKA_NGCWGS-NGCWGS03937_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='02ssy')
    has_data = 1
