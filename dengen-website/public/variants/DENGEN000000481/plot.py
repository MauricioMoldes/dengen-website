...
#   plot-vcfstats -p /mnt/dengen/results/outdir/62shendaf-103910114971-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01692-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05378 /mnt/dengen/results/stats/62shendaf-103910114971-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01692-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05378_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 62she .. /ngc/projects2/gm/data/archive/2022/variants/snv/62shendaf-103910114971-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01692-220921_A01961_AHY2KCDSX3-EXT_LABKA_NGCWGS-NGCWGS05378_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='62she')
    has_data = 1
