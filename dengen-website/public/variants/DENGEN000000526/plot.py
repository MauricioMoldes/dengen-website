...
#   plot-vcfstats -p /mnt/dengen/results/outdir/64powiref-103916076915-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01771-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05634 /mnt/dengen/results/stats/64powiref-103916076915-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01771-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05634_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 64pow .. /ngc/projects2/gm/data/archive/2022/variants/snv/64powiref-103916076915-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01771-220928_A01961_AH35JJDSX5-EXT_LABKA_NGCWGS-NGCWGS05634_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='64pow')
    has_data = 1
