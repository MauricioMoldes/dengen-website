...
#   plot-vcfstats -p /mnt/dengen/results/outdir/48tworerf-103882549658-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00905-220622_A01176_AHKCKLDSX3-EXT_LABKA_NGCWGS-NGCWGS04485 /mnt/dengen/results/stats/48tworerf-103882549658-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00905-220622_A01176_AHKCKLDSX3-EXT_LABKA_NGCWGS-NGCWGS04485_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 48two .. /ngc/projects2/gm/data/archive/2022/variants/snv/48tworerf-103882549658-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00905-220622_A01176_AHKCKLDSX3-EXT_LABKA_NGCWGS-NGCWGS04485_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='48two')
    has_data = 1
