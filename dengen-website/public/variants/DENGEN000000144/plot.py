...
#   plot-vcfstats -p /mnt/dengen/results/outdir/15ledteaf-103911220783-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01628-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05418_22RKG020118 /mnt/dengen/results/stats/15ledteaf-103911220783-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01628-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05418_22RKG020118_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 15led .. /ngc/projects2/gm/data/archive/2022/variants/snv/15ledteaf-103911220783-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01628-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05418_22RKG020118_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='15led')
    has_data = 1
