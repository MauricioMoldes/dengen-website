...
#   plot-vcfstats -p /mnt/dengen/results/outdir/52ebyswif-103914606011-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01776-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05610_22RKG011342 /mnt/dengen/results/stats/52ebyswif-103914606011-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01776-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05610_22RKG011342_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 52eby .. /ngc/projects2/gm/data/archive/2022/variants/snv/52ebyswif-103914606011-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01776-220928_A01176_BH3FHLDSX5-EXT_LABKA_NGCWGS-NGCWGS05610_22RKG011342_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='52eby')
    has_data = 1
