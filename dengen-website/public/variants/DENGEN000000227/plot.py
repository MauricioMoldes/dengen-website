...
#   plot-vcfstats -p /mnt/dengen/results/outdir/21tttermm-103886307942-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220629_A01176_BHMWTFDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04534_22RKG015483x01 /mnt/dengen/results/stats/21tttermm-103886307942-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220629_A01176_BHMWTFDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04534_22RKG015483x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 21ttt .. /ngc/projects2/gm/data/archive/2022/variants/snv/21tttermm-103886307942-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220629_A01176_BHMWTFDSX3-RHGM_LABKA_WGSAKUT-WGSAKUT04534_22RKG015483x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='21ttt')
    has_data = 1
