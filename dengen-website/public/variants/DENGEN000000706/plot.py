...
#   plot-vcfstats -p /mnt/dengen/results/outdir/70tlanenm-103838578826-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00616-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03894_22RKG002489x01 /mnt/dengen/results/stats/70tlanenm-103838578826-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00616-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03894_22RKG002489x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 70tla .. /ngc/projects2/gm/data/archive/2022/variants/snv/70tlanenm-103838578826-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00616-220225_A01176_BHCTJMDSX3-EXT_LABKA_NGCWGS-NGCWGS03894_22RKG002489x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='70tla')
    has_data = 1
