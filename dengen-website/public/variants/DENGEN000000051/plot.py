...
#   plot-vcfstats -p /mnt/dengen/results/outdir/05ntamemm-103880151142-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04448 /mnt/dengen/results/stats/05ntamemm-103880151142-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04448_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 05nta .. /ngc/projects2/gm/data/archive/2022/variants/snv/05ntamemm-103880151142-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-220615_A00559_BHKC2YDSX3-RHGM_LABKA_WGS-WGS04448_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='05nta')
    has_data = 1
