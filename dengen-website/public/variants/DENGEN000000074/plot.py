...
#   plot-vcfstats -p /mnt/dengen/results/outdir/07anecrem-103895585488-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01556-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05357_22rkg018207 /mnt/dengen/results/stats/07anecrem-103895585488-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01556-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05357_22rkg018207_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 07ane .. /ngc/projects2/gm/data/archive/2022/variants/snv/07anecrem-103895585488-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01556-220916_A01411_BHYNLVDSX3-EXT_LABKA_NGCWGS-NGCWGS05357_22rkg018207_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='07ane')
    has_data = 1
