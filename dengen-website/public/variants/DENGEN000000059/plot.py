...
#   plot-vcfstats -p /mnt/dengen/results/outdir/06ciswntm-103867454544-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00768-220512_A01466_AHJJ3NDSX3-EXT_LABKA_NGCWGS-NGCWGS04250_22RKG002997x01 /mnt/dengen/results/stats/06ciswntm-103867454544-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00768-220512_A01466_AHJJ3NDSX3-EXT_LABKA_NGCWGS-NGCWGS04250_22RKG002997x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 06cis .. /ngc/projects2/gm/data/archive/2022/variants/snv/06ciswntm-103867454544-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00768-220512_A01466_AHJJ3NDSX3-EXT_LABKA_NGCWGS-NGCWGS04250_22RKG002997x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='06cis')
    has_data = 1
