...
#   plot-vcfstats -p /mnt/dengen/results/outdir/17patimbm-103794069402-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00355-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00254_21RKG022419x01 /mnt/dengen/results/stats/17patimbm-103794069402-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00355-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00254_21RKG022419x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 17pat .. /ngc/projects2/gm/data/archive/2022/variants/snv/17patimbm-103794069402-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00355-211019_A01411_AHHHWJDSX2-EXT_LABKA_NGCWGS-NGCWGS00254_21RKG022419x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='17pat')
    has_data = 1
