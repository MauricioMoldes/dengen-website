...
#   plot-vcfstats -p /mnt/dengen/results/outdir/46thesnsf-110305510940-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02322-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06210 /mnt/dengen/results/stats/46thesnsf-110305510940-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02322-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06210_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 46the .. /ngc/projects2/gm/data/archive/2022/variants/snv/46thesnsf-110305510940-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02322-221111_A01961_AH3MFCDSX5-EXT_LABKA_NGCWGS-NGCWGS06210_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='46the')
    has_data = 1
