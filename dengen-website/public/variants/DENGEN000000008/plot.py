...
#   plot-vcfstats -p /mnt/dengen/results/outdir/00teprdtf-103888450696-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01739-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05500_22RKG016385 /mnt/dengen/results/stats/00teprdtf-103888450696-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01739-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05500_22RKG016385_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 00tep .. /ngc/projects2/gm/data/archive/2022/variants/snv/00teprdtf-103888450696-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01739-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05500_22RKG016385_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='00tep')
    has_data = 1
