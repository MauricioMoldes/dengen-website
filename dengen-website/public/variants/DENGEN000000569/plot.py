...
#   plot-vcfstats -p /mnt/dengen/results/outdir/65wicawnm-103755220650-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00201-210629_A00559_AHFHNHDSX2-EXT_LABKA_NGCWGS-NGCWGS00117_65wtu30b5 /mnt/dengen/results/stats/65wicawnm-103755220650-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00201-210629_A00559_AHFHNHDSX2-EXT_LABKA_NGCWGS-NGCWGS00117_65wtu30b5_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 65wic .. /ngc/projects2/gm/data/archive/2022/variants/snv/65wicawnm-103755220650-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00201-210629_A00559_AHFHNHDSX2-EXT_LABKA_NGCWGS-NGCWGS00117_65wtu30b5_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='65wic')
    has_data = 1
