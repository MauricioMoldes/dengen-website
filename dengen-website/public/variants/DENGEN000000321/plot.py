...
#   plot-vcfstats -p /mnt/dengen/results/outdir/50neforam-103912389838-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01634-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05426 /mnt/dengen/results/stats/50neforam-103912389838-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01634-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05426_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 50nef .. /ngc/projects2/gm/data/archive/2022/variants/snv/50neforam-103912389838-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01634-220921_A00559_BHYLJMDSX3-EXT_LABKA_NGCWGS-NGCWGS05426_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='50nef')
    has_data = 1
