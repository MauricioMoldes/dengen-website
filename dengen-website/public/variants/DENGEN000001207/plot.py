...
#   plot-vcfstats -p /mnt/dengen/results/outdir/81ctadeam-103836015425-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00578-220209_A01176_BHCWJ5DSX3-EXT_LABKA_NGCWGS-NGCWGS03810_21RKG032140x01 /mnt/dengen/results/stats/81ctadeam-103836015425-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00578-220209_A01176_BHCWJ5DSX3-EXT_LABKA_NGCWGS-NGCWGS03810_21RKG032140x01_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 81cta .. /ngc/projects2/gm/data/archive/2022/variants/snv/81ctadeam-103836015425-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00578-220209_A01176_BHCWJ5DSX3-EXT_LABKA_NGCWGS-NGCWGS03810_21RKG032140x01_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='81cta')
    has_data = 1
