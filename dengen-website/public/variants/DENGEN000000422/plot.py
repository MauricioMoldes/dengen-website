...
#   plot-vcfstats -p /mnt/dengen/results/outdir/59anevenm-110304148636-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02334-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06230 /mnt/dengen/results/stats/59anevenm-110304148636-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02334-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06230_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 59ane .. /ngc/projects2/gm/data/archive/2022/variants/snv/59anevenm-110304148636-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02334-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06230_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='59ane')
    has_data = 1
