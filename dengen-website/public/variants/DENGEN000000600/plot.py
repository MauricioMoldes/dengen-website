...
#   plot-vcfstats -p /mnt/dengen/results/outdir/66wnthetf-110302538135-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02343-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06240 /mnt/dengen/results/stats/66wnthetf-110302538135-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02343-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06240_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 66wnt .. /ngc/projects2/gm/data/archive/2022/variants/snv/66wnthetf-110302538135-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02343-221116_A00559_BHF53WDSX5-EXT_LABKA_NGCWGS-NGCWGS06240_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='66wnt')
    has_data = 1
