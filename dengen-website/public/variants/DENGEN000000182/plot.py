...
#   plot-vcfstats -p /mnt/dengen/results/outdir/19icheatf-103898379439-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01515-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05308_22RKG018818 /mnt/dengen/results/stats/19icheatf-103898379439-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01515-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05308_22RKG018818_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 19ich .. /ngc/projects2/gm/data/archive/2022/variants/snv/19icheatf-103898379439-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01515-220914_A00559_BHTNKTDSX3-EXT_LABKA_NGCWGS-NGCWGS05308_22RKG018818_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='19ich')
    has_data = 1
