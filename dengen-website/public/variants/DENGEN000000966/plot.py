...
#   plot-vcfstats -p /mnt/dengen/results/outdir/77bulmiaf-103820408732-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211229_A00559_AHT7WGDSX2-RHGM_LABKA_WGS-WGS03603 /mnt/dengen/results/stats/77bulmiaf-103820408732-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211229_A00559_AHT7WGDSX2-RHGM_LABKA_WGS-WGS03603_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 77bul .. /ngc/projects2/gm/data/archive/2022/variants/snv/77bulmiaf-103820408732-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_X-211229_A00559_AHT7WGDSX2-RHGM_LABKA_WGS-WGS03603_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='77bul')
    has_data = 1
