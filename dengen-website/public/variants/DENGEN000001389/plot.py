...
#   plot-vcfstats -p /mnt/dengen/results/outdir/83viotswm-103895709764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01051-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04747 /mnt/dengen/results/stats/83viotswm-103895709764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01051-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04747_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 83vio .. /ngc/projects2/gm/data/archive/2022/variants/snv/83viotswm-103895709764-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01051-220803_A00559_AHNW22DSX3-EXT_LABKA_NGCWGS-NGCWGS04747_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='83vio')
    has_data = 1
