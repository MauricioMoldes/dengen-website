...
#   plot-vcfstats -p /mnt/dengen/results/outdir/58othalcm-110302516050-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02267-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06152_22RKG025987 /mnt/dengen/results/stats/58othalcm-110302516050-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02267-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06152_22RKG025987_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 58oth .. /ngc/projects2/gm/data/archive/2022/variants/snv/58othalcm-110302516050-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02267-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06152_22RKG025987_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='58oth')
    has_data = 1
