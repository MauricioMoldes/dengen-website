...
#   plot-vcfstats -p /mnt/dengen/results/outdir/06tenfanm-110302538097-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02262-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06147_22RKG020263 /mnt/dengen/results/stats/06tenfanm-110302538097-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02262-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06147_22RKG020263_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 06ten .. /ngc/projects2/gm/data/archive/2022/variants/snv/06tenfanm-110302538097-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02262-221109_A01411_BH3NLCDSX5-EXT_LABKA_NGCWGS-NGCWGS06147_22RKG020263_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='06ten')
    has_data = 1
