...
#   plot-vcfstats -p /mnt/dengen/results/outdir/75dacentm-103913366785-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01828-220928_A00559_AH3FVNDSX5-EXT_LABKA_NGCWGS-NGCWGS05556_16RKG011388 /mnt/dengen/results/stats/75dacentm-103913366785-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01828-220928_A00559_AH3FVNDSX5-EXT_LABKA_NGCWGS-NGCWGS05556_16RKG011388_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 75dac .. /ngc/projects2/gm/data/archive/2022/variants/snv/75dacentm-103913366785-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01828-220928_A00559_AH3FVNDSX5-EXT_LABKA_NGCWGS-NGCWGS05556_16RKG011388_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='75dac')
    has_data = 1
