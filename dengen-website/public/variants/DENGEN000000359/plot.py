...
#   plot-vcfstats -p /mnt/dengen/results/outdir/53veldtom-110302939148-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02285-221109_A01961_AH3KN7DSX5-EXT_LABKA_NGCWGS-NGCWGS06170 /mnt/dengen/results/stats/53veldtom-110302939148-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02285-221109_A01961_AH3KN7DSX5-EXT_LABKA_NGCWGS-NGCWGS06170_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 53vel .. /ngc/projects2/gm/data/archive/2022/variants/snv/53veldtom-110302939148-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02285-221109_A01961_AH3KN7DSX5-EXT_LABKA_NGCWGS-NGCWGS06170_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='53vel')
    has_data = 1
