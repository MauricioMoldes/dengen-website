...
#   plot-vcfstats -p /mnt/dengen/results/outdir/04stodplf-103909048170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01335-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05113_22RKG014888 /mnt/dengen/results/stats/04stodplf-103909048170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01335-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05113_22RKG014888_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 04sto .. /ngc/projects2/gm/data/archive/2022/variants/snv/04stodplf-103909048170-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01335-220909_A01961_AHY2C5DSX3-EXT_LABKA_NGCWGS-NGCWGS05113_22RKG014888_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='04sto')
    has_data = 1
