...
#   plot-vcfstats -p /mnt/dengen/results/outdir/49tractsf-103913410423-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01744-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05505_22RKG017936 /mnt/dengen/results/stats/49tractsf-103913410423-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01744-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05505_22RKG017936_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 49tra .. /ngc/projects2/gm/data/archive/2022/variants/snv/49tractsf-103913410423-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01744-220923_A01176_BHTNN3DSX3-EXT_LABKA_NGCWGS-NGCWGS05505_22RKG017936_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='49tra')
    has_data = 1
