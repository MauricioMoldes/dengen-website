...
#   plot-vcfstats -p /mnt/dengen/results/outdir/45gconcom-103917316120-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01880-221005_A01961_AH35TTDSX5-EXT_LABKA_NGCWGS-NGCWGS05693 /mnt/dengen/results/stats/45gconcom-103917316120-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01880-221005_A01961_AH35TTDSX5-EXT_LABKA_NGCWGS-NGCWGS05693_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 45gco .. /ngc/projects2/gm/data/archive/2022/variants/snv/45gconcom-103917316120-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01880-221005_A01961_AH35TTDSX5-EXT_LABKA_NGCWGS-NGCWGS05693_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='45gco')
    has_data = 1
