...
#   plot-vcfstats -p /mnt/dengen/results/outdir/07carellf-103742119611-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00186-210618_A00559_AH7VCGDSX2-EXT_LABKA_NGCWGS-NGCWGS00104_0744vc2u8 /mnt/dengen/results/stats/07carellf-103742119611-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00186-210618_A00559_AH7VCGDSX2-EXT_LABKA_NGCWGS-NGCWGS00104_0744vc2u8_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 07car .. /ngc/projects2/gm/data/archive/2022/variants/snv/07carellf-103742119611-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM00186-210618_A00559_AH7VCGDSX2-EXT_LABKA_NGCWGS-NGCWGS00104_0744vc2u8_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='07car')
    has_data = 1
