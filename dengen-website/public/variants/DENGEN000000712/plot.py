...
#   plot-vcfstats -p /mnt/dengen/results/outdir/71adthatm-110302932755-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02210-221109_A01176_AH3NY7DSX5-EXT_LABKA_NGCWGS-NGCWGS06092 /mnt/dengen/results/stats/71adthatm-110302932755-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02210-221109_A01176_AH3NY7DSX5-EXT_LABKA_NGCWGS-NGCWGS06092_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 71adt .. /ngc/projects2/gm/data/archive/2022/variants/snv/71adthatm-110302932755-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02210-221109_A01176_AH3NY7DSX5-EXT_LABKA_NGCWGS-NGCWGS06092_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='71adt')
    has_data = 1
