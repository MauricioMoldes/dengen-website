...
#   plot-vcfstats -p /mnt/dengen/results/outdir/82frethif-110295680923-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01995-221014_A00559_BH3FK3DSX5-EXT_LABKA_NGCWGS-NGCWGS05842 /mnt/dengen/results/stats/82frethif-110295680923-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01995-221014_A00559_BH3FK3DSX5-EXT_LABKA_NGCWGS-NGCWGS05842_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 82fre .. /ngc/projects2/gm/data/archive/2022/variants/snv/82frethif-110295680923-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01995-221014_A00559_BH3FK3DSX5-EXT_LABKA_NGCWGS-NGCWGS05842_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='82fre')
    has_data = 1
