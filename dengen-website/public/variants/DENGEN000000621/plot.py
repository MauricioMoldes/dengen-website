...
#   plot-vcfstats -p /mnt/dengen/results/outdir/67reffedf-110297591316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02044-221019_A01411_AH3CYYDSX5-EXT_LABKA_NGCWGS-NGCWGS05926 /mnt/dengen/results/stats/67reffedf-110297591316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02044-221019_A01411_AH3CYYDSX5-EXT_LABKA_NGCWGS-NGCWGS05926_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 67ref .. /ngc/projects2/gm/data/archive/2022/variants/snv/67reffedf-110297591316-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM02044-221019_A01411_AH3CYYDSX5-EXT_LABKA_NGCWGS-NGCWGS05926_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='67ref')
    has_data = 1
