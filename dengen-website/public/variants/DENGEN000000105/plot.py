...
#   plot-vcfstats -p /mnt/dengen/results/outdir/09menekif-103910880569-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01543-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05386 /mnt/dengen/results/stats/09menekif-103910880569-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01543-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05386_snv_germline_raw.haplotype_caller.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. 09men .. /ngc/projects2/gm/data/archive/2022/variants/snv/09menekif-103910880569-Normal_Blood_noinfo-WGS_v1_IlluminaDNAPCRFree_RHGM01543-220916_A01411_AHTJ7JDSX3-EXT_LABKA_NGCWGS-NGCWGS05386_snv_germline_raw.haplotype_caller.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='09men')
    has_data = 1
